    ...
    if (calmToggle) {
            ...
            <div className="card_description_icon_wrapper_container">
              ...
              <div className="card_description_paragraph_icon_wrapper">
                <FontAwesomeIcon
                  ...
                  icon={faTag}
                />
                <p className="card_description_paragraph_title">Prezzo</p>
              </div>
              <div className="card_description_paragraph_value">
                <p>40€</p>
              </div>
      ...
      return (
        <p className="card_description_paragraph">
          La pulizia del viso è, probabilmente, il trattamento più importante per prevenire o trattare acne ed impurità cutanee. La pulizia del viso permette di purificare a fondo la pelle attraverso la rimozione di cellule morte, punti neri, brufoletti od altri piccoli difetti cutanei
        </p>
      );
    }
  };
      ...
      <div className="big_screen_entire_bottom_wrapper">
        ...
        <div className="big_screen_duration_wrapper">
          <FontAwesomeIcon
            ...
            icon={faClock}
          />
          <p className="big_screen_duration">1 ora</p>
        </div>
      </div>
    );
  };
    ...
    return (
      ...
      >
        <p className="card_toggler" onClick={handleToggle}>
          {calmToggle ? "GUARDA DESCRIZIONE" : "LEGGI DESCRIZIONE"}
        </p>
  ...
  const bigScreenAddToCartButton = () => {
    if (calmInCart) {
      return (
        <>
          {checkMark()}
          <p className="big_screen_in_cart">NEL CARRELLO</p>
        </>
      );
    } else {
      return (
                ...
                <section className="card" style={styleprops}>
                  ...
                  >
                    <div className="card_description_inner_wrapper">
                      <h2 style={{ fontWeight: 400 }}>PULIZIA VISO</h2>
                      <p

  ...
  const handleSubmitBooking = (e) => {
    ...
    if (beforeSalt.length > 0) {
      const beforeAppStartTime = moment(
        ...
        .subtract(beforeSalt[0].duration, "minuti")
        .format("h:mm A");
      const beforeAppEndTime = moment(
        appDate + " " + beforeAppStartTime,
        "MMMM D, YYYY h:mm A"
      )
        .add(beforeSalt[0].duration, "minuti")
        .format("h:mm");
        ...
        ((styleprops) => (
          ...
          >
            ...
            <div className="admin_individual_selected_client_back_container">
              ...
              />
              <p onClick={handleBackToSchedule}>Torna alle prenotazioni</p>
            ...
            <div className="admin_create_appointment_input_information_container">
              <div className="admin_create_appointment_label">Personale</div>
              <Dropdown
                options={
                  getEmployeeData
            ...
            <div className="admin_create_appointment_service_label_container">
              <div className="admin_create_appointment_label">Servizi</div>
              <div className="admin_create_appointment_label">Durata</div>
              <div

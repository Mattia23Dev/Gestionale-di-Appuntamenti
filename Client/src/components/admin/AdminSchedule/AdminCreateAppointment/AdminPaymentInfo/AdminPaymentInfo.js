    ...
    <div className="admin_square_payment_form_container">
      ...
      >
        <div className="admin_create_appointment_input_information_container">
          <div className="sq-label">Scegli una carta di credito</div>
          <Dropdown
            options={[
              {
                value: JSON.stringify({
        ...
        <div className="admin_create_appointment_cardholder_container">
          <span className="sq-label">Nome proprietario</span>
          <input
            className="sq-input"
        ...
        <div className="admin_create_appointment_cardholder_container">
          <span className="sq-label">Cognome proprietario</span>
          <input
            className="sq-input"
        ...
        {selectedCreditCardFullData ? (
          <>
            <div className="sq-selected-credit-card-details">
              ...
              <span className="sq-label">Carta di credito &nbsp;</span>
              <input
                name="credit_card"
                type="text"
                maxLength="100"
            ...
            <div>
              ...
              <span className="sq-label">Scadenza &nbsp;</span>
              <input
            ...
            <div>
              ...
              <span className="sq-label">Codice postale &nbsp;</span>
              <input
                name="postal_code"
                type="text"
                className="sq-input"
        ...
        <CreditCardSubmitButton>Prenota appuntamento</CreditCardSubmitButton>
      </SquarePaymentForm>

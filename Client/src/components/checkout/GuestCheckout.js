  ...
  const renderRemainingCharacters = () => {
    ...
    if (appointmentNotes) {
      ...
      if (500 - appointmentNotes.length === 1) {
        remainingCharacters.push(" caratteri rimanenti).");
        ...
        if (500 - appointmentNotes.length < 0) {
          remainingCharacters.push(" troppi).");
  ...
  return (
    <div className="checkout_container">
      ...
      <div className="checkout_header">
        <h2>CHECKOUT COME OSPITE O REGISTRA IL TUO ACCOUNT</h2>
      </div>
      <div className="guest_checkout_form_container">
        <Form>
            ...
            <Label for="firstName">
              ...
              <div className="top_form_container">
                <div className="required_label">
                  Nome<p className="required_label red_asterisk">* </p>
                </div>
                <div className="required_fields_container">
                  <p className="red_asterisk">* </p>{" "}
                  <p className="required_fields_statement"> Campo obbligatorio</p>
                </div>
              </div>
            </Label>
            <Input
          ...
          <FormGroup>
            <Label for="lastName">
              <div className="required_label">
                Cognome<p className="required_label red_asterisk">* </p>
              </div>
            </Label>
            <Input
              type="text"
          ...
          <FormGroup>
            ...
            <Input
              ...
              maxLength={1000}
              placeholder="Inserisci qualsiasi nota che sia utile per noi."
            ...
            >
              ...
              >
                Massimo 500 caratteri {renderRemainingCharacters()}
              </p>
              <p>
                Per proteggere la tua privacy non includere nessun tipo di informazione sanitaria.{" "}
              </p>
            </FormText>
          </FormGroup>
        </Form>

        ...
        <>
          <div className="empty_cart_container">
            <FontAwesomeIcon
              ...
              icon={faShoppingCart}
            />
            <h3>Non ci sono prenotazioni in corso</h3>
          </div>
          <p className="cart_statement">
            Non hai nessun trattamento da prenotare, per favore scegli il tipo di trattamento nella home.
          </p>
        </>
      );
    } else {
      ...
      {treatmentsArr.length === 0 || saltCaveInCart ? null : (
        <div className="esthetician_preference_dropdown">
          <FormGroup className="esthetician_preference_formgroup">
            <p>
              Vuoi prenotare un appuntamento con una particolare Estetista / Massaggiatrice
            </p>
